...
test_data = [
		...
		("PSGS1",
 		...
 		("PSGS1_masked",
			sgs_simulation, [variogram2, neighbourhood1, {"prop": prop_cont, "grid": grid, "seed": 3439275, "kriging_type": "sk", "workers_count": 2}],
			 "current/PSGS1_MASKED.INC", "PSGS1_MASKED",
			 "fixed/SGS1_MASKED.INC"),
		("SGS_CDF_EQUAL",
		...
		("SGS_LVM", sgs_simulation, [variogram2, neighbourhood1, {"prop": prop_cont, "grid": grid, "seed": 3439275, "mean_data": lvm_mean_data}],
			...
			"fixed/SGS_LVM.INC"),
		("PSGS_LVM", sgs_simulation, [variogram2, neighbourhood1, {"prop": prop_cont, "grid": grid, "seed": 3439275, "mean_data": lvm_mean_data, "workers_count": 2}],
			"current/PSGS_LVM.INC", "PSGS_LVM", 
			"fixed/SGS_LVM.INC"),
		("PSGS_LVM_Regions", sgs_simulation, [variogram2, neighbourhood1, {"prop": prop_cont, "grid": grid, "seed": 3439275, "mean_data": lvm_mean_data,  "use_new_psgs": True, "force_parallel": True, "workers_count": 2}],
			"current/PSGS_LVM_REGIONS.INC", "PSGS_LVM_REGIONS", 
			"fixed/SGS_LVM_REGIONS.INC"),
		...
		("IK_Multi_Facies", indicator_kriging, [{"prop": multi_ik_prop, "grid": grid, "data": multi_ik_data}],
		...
		("SIS_Multi_Facies", sis_simulation, [{"prop": multi_ik_prop, "grid": grid, "data": multi_ik_data, "seed": 3241347}],
		...
		("PSIS", sis_simulation, [{"prop": ik_prop, "grid": grid, "data": ik_data, "seed": 3241347, "workers_count": 2}],
			...
			"fixed/RESULT_SIS_BIG_SOFT.INC"),
		("PSIS_Multi_Facies", sis_simulation, [{"prop": multi_ik_prop, "grid": grid, "data": multi_ik_data, "seed": 3241347, "workers_count": 2}],
			"current//RESULT_PSIS_MULTI.INC", "PSIS_RESULT_MULTI",
			"fixed/RESULT_SIS_MULTI.INC"),
		...
		("PSGS_Regions", sgs_simulation, [variogram2, neighbourhood1, {"prop": prop_cont, "grid": grid, "seed": 3439275, "kriging_type": "sk", "use_new_psgs": True, "force_parallel": True, "workers_count": 2, "min_neighbours": 5 }],
			 "current/PSGS_REGIONS.INC", "PSGS_REGIONS",
			 "fixed/PSGS_REGIONS.INC"),
		("PSGS_Regions_masked", sgs_simulation, [variogram2, neighbourhood1, {"prop": prop_cont, "grid": grid, "seed": 3439275, "kriging_type": "sk", "use_new_psgs": True, "force_parallel": True, "workers_count": 2, "mask": mask_prop }],
			 "current/PSGS_REGIONS_MASKED.INC", "PSGS_REGIONS_MASKED",
			 "fixed/PSGS_REGIONS_MASKED.INC"),
		("PSIS_Regions", sis_simulation, [{"prop": ik_prop, "grid": grid, "data": ik_data, "seed": 3241347, "use_psis_5": True, "force_parallel": True, "workers_count": 2, "min_neighbours": 5}],
			"current//RESULT_PSIS_REGIONS.INC", "PSIS_RESULT_REGIONS",
			"fixed/RESULT_PSIS_REGIONS.INC"),
		("PSIS_Regions_Multi", sis_simulation, [{"prop": multi_ik_prop, "grid": grid, "data": multi_ik_data, "seed": 3241347, "use_psis_5": True, "force_parallel": True, "workers_count": 2, "min_neighbours": 5}],
			"current//RESULT_PSIS_REGIONS_MULTI.INC", "PSIS_RESULT_REGIONS_MULTI",
			"fixed/RESULT_PSIS_REGIONS_MULTI.INC"),
		("PSIS_Regions_masked", sis_simulation, [{"prop": ik_prop, "grid": grid, "data": ik_data, "seed": 3241347, "use_psis_5": True, "force_parallel": True, "workers_count": 2, "mask": mask_prop}],
			"current//RESULT_PSIS_REGIONS_MASKED.INC", "PSIS_RESULT_REGIONS_MASKED",
			"fixed/RESULT_PSIS_REGIONS_MASKED.INC"),
		...
		("PSIS_LVM", sis_simulation, [{"prop": ik_prop, "grid": grid, "data": ik_data, "seed": 3241347, "workers_count": 2, "mean_data": [1 - mean_prop, mean_prop]}],
			"current//RESULT_PSIS_BIG_SOFT_LVM.INC", "PSIS_RESULT_BIG_SOFT_LVM",
			"fixed/RESULT_SIS_BIG_SOFT_LVM.INC"),
		("PSIS_Regions_LVM", sis_simulation, [{"prop": ik_prop, "grid": grid, "data": ik_data, "seed": 3241347, "use_psis_5": True, "force_parallel": True, "workers_count": 2, "mean_data": [1 - mean_prop, mean_prop],  "min_neighbours": 5, "use_corellogram": False}],
			"current//RESULT_PSIS_REGIONS_LVM.INC", "PSIS_RESULT_REGIONS_LVM",
			"fixed/RESULT_PSIS_REGIONS_LVM.INC"),
