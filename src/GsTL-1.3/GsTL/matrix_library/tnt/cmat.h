...
class Matrix 
{
  ...
  public:
    ...
    inline Subscript dim(Subscript d) const 
    {
    ...
    inline Subscript num_rows() const { return m_; }
    inline Subscript num_cols() const { return n_; }
...
// Added by Nicolas Remy. feb 05, 2002
template <class T>
