...
/* This class was slightly modified to meet the requirements detailed in 
 * "GsTL: the Geostatistical Library in C++", Nicolas Remy, March 2001 
 * Master Thesis, Stanford University
 * function newsize was renamed resize
 */
...
class Vector 
{
  ...
  public:
    ...
    /* This function was added by Nicolas Remy.
     * It defeats the purpose of implementation hidding but is useful when 
     * the vector must be used in "translated fortran" or C code
     */
    inline T* raw_access() {return v_;}
